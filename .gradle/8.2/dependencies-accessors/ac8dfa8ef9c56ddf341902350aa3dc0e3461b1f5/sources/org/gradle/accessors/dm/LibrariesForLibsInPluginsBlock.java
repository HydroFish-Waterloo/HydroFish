...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class HiltVersionAccessors extends VersionFactory  {
        ...
        public HiltVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: hilt.android (2.46)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginVersionAccessors extends VersionFactory  {
        ...
        private final PluginAndroidVersionAccessors vaccForPluginAndroidVersionAccessors = new PluginAndroidVersionAccessors(providers, config);
        public PluginVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: plugin.kotlin (1.8.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
        ...
        /**
         * Returns the group of versions at versions.plugin.android
         */
        public PluginAndroidVersionAccessors getAndroid() {
            return vaccForPluginAndroidVersionAccessors;
        }

    }

    public static class PluginAndroidVersionAccessors extends VersionFactory  {

        public PluginAndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: plugin.android.app (8.2.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getApp() { return getVersion("plugin.android.app"); }
